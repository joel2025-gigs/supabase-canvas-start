...
const navItems: NavItem[] = [
  {
    ...
    roles: ["super_admin", "admin", "operations_admin", "accountant", "sales_admin", "sales_officer", "credit_admin", "credit_officer", "recovery_admin", "recovery_officer", "operations_officer", "staff"],
  },
  // Loans & Departments
  {
    label: "All Loans",
    ...
    roles: ["super_admin", "admin", "operations_admin", "accountant", "credit_admin", "credit_officer", "recovery_admin", "recovery_officer"],
    section: "Loans",
  },
  {
    label: "Sales",
    ...
    roles: ["super_admin", "admin", "sales_admin", "sales_officer"],
    section: "Loans",
  },
  {
    ...
    roles: ["super_admin", "admin", "credit_admin", "credit_officer", "accountant"],
    section: "Loans",
  },
  {
    label: "Recovery",
    ...
    roles: ["super_admin", "admin", "recovery_admin", "recovery_officer"],
    section: "Loans",
  },
  // Operations
  {
  ...
  },
  {
    ...
    roles: ["super_admin", "admin", "operations_admin", "accountant", "credit_admin", "credit_officer"],
    section: "Operations",
  },
  {
    label: "Assets",
    ...
    roles: ["super_admin", "admin", "operations_admin", "accountant"],
    section: "Operations",
  },
  {
    label: "Payments",
  ...
  },
  {
    ...
    href: "/jobs",
    icon: <Briefcase className="h-5 w-5" />,
    roles: ["super_admin", "admin", "operations_admin"],
    section: "Operations",
  },
  // Admin (super_admin only for most items)
  {
    label: "Branches",
    href: "/branches",
